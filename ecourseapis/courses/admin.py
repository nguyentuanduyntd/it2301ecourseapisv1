...
class CourseAdmin(admin.ModelAdmin):
    ...
    def avatar(self, course):
        return mark_safe(f'<img src="{course.image.url}" width="150" height="150" />')
...
class MyAdminSite(admin.AdminSite):
    ...
    def course_stats(self, request):
        stats = Category.objects.annotate(c=Count('courses')).values('c')
        return TemplateResponse(request, 'admin/course_stats.html', {'stats': stats})
